...
@Component({
  selector: 'app-inox-bangalore',
  templateUrl: './inox-bangalore.component.html',
  styleUrls: ['./inox-bangalore.component.css']
})
export class InoxBangaloreComponent implements OnInit {
