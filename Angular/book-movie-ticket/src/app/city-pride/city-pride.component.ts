...
@Component({
  selector: 'app-city-pride',
  templateUrl: './city-pride.component.html',
  styleUrls: ['./city-pride.component.css']
})
export class CityPrideComponent implements OnInit {

  movies;
  constructor(private http: HttpClient, private dialog: MatDialog, private route: Router, private bookMovieTicket: BookMovieTicketService) { 
              this.getMovieData();
  }
