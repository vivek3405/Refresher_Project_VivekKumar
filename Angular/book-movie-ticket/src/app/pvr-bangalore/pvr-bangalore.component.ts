...
@Component({
  selector: 'app-pvr-bangalore',
  templateUrl: './pvr-bangalore.component.html',
  styleUrls: ['./pvr-bangalore.component.css']
})
export class PvrBangaloreComponent implements OnInit {
